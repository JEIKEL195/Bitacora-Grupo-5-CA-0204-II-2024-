...
La siguiente prueba tomamos con referencia el método del libro de Probabilidad y Estadística de [@morris1988]. Esta prueba la utilizamos cuando queremos comparar la media de dos poblaciones, digamos que se utiliza cuando queremos ver la relación entre variables numéricas con variables categóricas, ya que dividimos entre las poblaciones, que viene siendo las poblaciones y las medias salen de la variable numérica. 
